...
type TypedSource[object client.Object, request comparable] interface {
	ForCluster(string, cluster.Cluster) (source.TypedSource[mcreconcile.TypedRequest[request]], error)
}

// SyncingSource is a source that needs syncing prior to being usable. The controller
// will call its WaitForSync prior to starting workers.
type SyncingSource[object client.Object] TypedSyncingSource[object, reconcile.Request]
...
type TypedSyncingSource[object client.Object, request comparable] interface {
	...
	SyncingForCluster(string, cluster.Cluster) (source.TypedSyncingSource[mcreconcile.TypedRequest[request]], error)
