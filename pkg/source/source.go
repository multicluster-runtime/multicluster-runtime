...
//
// Users may build their own Source implementations.
type TypedSource[object client.Object, request mcreconcile.ClusterAware] interface {
...
// will call its WaitForSync prior to starting workers.
type TypedSyncingSource[object client.Object, request mcreconcile.ClusterAware] interface {
