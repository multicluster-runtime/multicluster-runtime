...
type TypedBuilder[request mcreconcile.ClusterAware] struct {
	forInput         ForInput
	ownsInput        []OwnsInput
...
func TypedControllerManagedBy[request mcreconcile.ClusterAware](m mcmanager.Manager) *TypedBuilder[request] {
...
type WatchesInput[request mcreconcile.ClusterAware] struct {
	obj              client.Object
